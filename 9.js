...
var strings = {
	witr: "猜猜金币在哪儿？<br>（请选择）",
	fail: ["是不是眼花了？", "别乱选，看准了再选哦", "太快了吗？"],
	ok: ["你可以的", "眼神不错", "再接再厉", "真的假的", "认真起来了", "很好", "太棒了", "下一关会更难哦", "牛逼！", "不可思议", "太夸张了吧", "太厉害了有木有？？", "你是怎么做到的？！", "肯定是运气！", "你的眼力那么好，你家人知道吗？", "不会再让你过关的，小心哦！", "简直无法置信！", "从来没有人能到这一关", "大神，教教我你的诀窍吧！", "你赢了，截图发我微信要红包"]
};
var init = function() {
